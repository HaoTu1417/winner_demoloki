                           ...
                           <div class="col-lg-2 col">
                              <div class="row text-muted text-center">
                                 <div class="col-12 border-end border-end-dashed">
                                    ...
                                    <p class="text-muted mb-0">@lang('173')</p>
                                 </div>
                           ...
                           <div class="col-lg-4 col">
                              <div class="row text-muted text-center">
                                 <div class="col-6 border-end border-end-dashed">
                                    ...
                                    <p class="text-muted mb-0">@lang('174')</p>
                                 </div>
                                 <div class="col-6">
                                    <h5 class="mb-1 projects-num">{{number_format($each->profit_total, 0, ',', '.')}}</h5>
                                    <p class="text-muted mb-0">@lang('175')</p>
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-2 col">
                              <div class="text-end">                               
                              <a href="#" class="js-show-his btn btn-light view-btn">@lang('182')</a>                            
                              </div>
                           </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach($each->historys as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if($item->type == 1)
                                                    <span style="color:green">@lang('180') </span>
                                                @elseif($item->type ==2)
                                                    <span style="color:red">@lang('181') </span>
                                                @else
                                                    <span style="color:orange">@lang('228')</span>
                                                @endif
                                            </td>
                                            <td>{{ number_format($item->money, 0, ',', '.') }} VND</td>
                                            <td>
                                                @lang('179'): <strong>{{ number_format($item->wallet_money, 0, ',', '.') }} VND</strong><br>
                                                @lang('24'): <strong>{{ number_format($item->cus_money, 0, ',', '.') }} VND</strong><br>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
