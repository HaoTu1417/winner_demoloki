                                    ...
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-sm-auto ms-auto">
                                            <div class="hstack gap-2">
                                                ...
                                                <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#modal_create"><i class="ri-add-line align-bottom me-1"></i> @lang(189)</button>
                                            ...
                                            <table class="table align-middle" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="">#</th>
                                                        <th class="">@lang('188')</th>
                                                        <th class="" >@lang('177')</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td >
                                                            @if($value->type == 1)
                                                                <span style="color:green">@lang('190')</span>
                                                            @elseif($value->type==2)
                                                                <span style="color:orange">@lang('191')</span>
                                                            @else
                                                                <span style="color:blue">@lang('192')</span>
                                                            @endif
                                                        </td>
                                                         <td >
                                                            @if($value->status == 1)
                                                                <span style="color:green">@lang('140')</span>
                                                            @else
                                                                <span style="color:red">@lang('141')</span>
                                                            @endif
                                                        </td>
                                                 ...
                                                 <form id="form-create-customer" class="tablelist-form" autocomplete="off" enctype="multipart/form-data">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div>
                                                                    <label for="type-field" class="form-label">@lang('177')</label>
                                                                    <select name="type" id="type-field" class="form-control">
                                                                        <option value="1">@lang('190')</option>
                                                                        <option value="2">@lang('191')</option>
                                                                        <option value="3">@lang('192')</option>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div>
                                                                    <label for="status-field" class="form-label">@lang('33')</label>
                                                                    <select name="status" id="status-field" class="form-control">
                                                                        <option value="1">@lang('141')</option>
                                                                        <option value="0">@lang('140')</option>
                                                                    </select>
