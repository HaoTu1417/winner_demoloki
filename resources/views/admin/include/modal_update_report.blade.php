            ...
            <form id="form-update-customer" class="tablelist-form" autocomplete="off">
               ...
               <div class="row g-3">
                  <div class="col-lg-12">
                     <div>
                        <label for="title-field" class="form-label">@lang(119)</label>
                  ...
                  <div class="col-lg-12">
                     <div>
                        <label for="description-field" class="form-label">@lang(120)</label>
                  ...
                  <div class="col-lg-12">
                     <div>
                        <label for="note-field" class="form-label">@lang(124)</label>
