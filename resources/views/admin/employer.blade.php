                                    ...
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-sm-auto ms-auto">
                                            <div class="hstack gap-2">
                                                ...
                                                <a href="/manager/add-employer"  class="btn btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> @lang('256')</a>
                                            ...
                                            <table class="table align-middle" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="">#</th>
                                                        <th class="">@lang('211')</th>
                                                        <th class="">@lang('208')</th>
                                                        <th class="">@lang('46')</th>
                                                        ...
                                                        <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                ...
                                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                                    <a href="{{route('edit-employer',['id'=>$value->id])}}" class="edit-item-btn" data-id="{{$value->id}}" ><i class="ri-pencil-fill align-bottom text-muted"></i></a>
                                                                </li>
