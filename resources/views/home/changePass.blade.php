    ...
    <div class="container homecontainer js-container-main" style="background:#f6f6f6">
        <div class="header-default" style="display:flex;background:#fff !important;border-bottom:1px solid #ccc">
               <a href="#" onclick="history.back()"  style="text-decoration:none;flex:1;height: 50px;">
                ...
                <div  style="flex:1;color:#333;display:flex;justify-content:center;align-items:center;font-size:20px;white-space:nowrap">Thay đổi mật khẩu</div>
        ...
        <div style="padding:15px;margin:10px;background-color:#fff;display:flex;justify-content:space-between">
           <span>Nhập mật khẩu mới</span>
            ...
            <input class="js-pass-new" placeholder="nhập mật khẩu mới" style="background-color:white !important;border:none;outline:none;padding:0 !important" maxlength="140" step="0.000000000000000001" enterkeyhint="done" pattern="[0-9]*" autocomplete="off" type="password" class="uni-input-input">
        ...
        <div style="padding:15px;margin:10px;background-color:#fff;display:flex;justify-content:space-between">
           <span>Nhập lại mật khẩu mới</span>
            ...
            <input class="js-pass-new-confirm" placeholder="nhập lại mật khẩu mới" style="background-color:white !important;border:none;outline:none;padding:0 !important" maxlength="140" step="0.000000000000000001" enterkeyhint="done" pattern="[0-9]*" autocomplete="off" type="password" class="uni-input-input">
