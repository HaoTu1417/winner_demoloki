    ...
    <div class="container homecontainer " style="background:#fff">
        <div class="header-default" style="display:flex;background:#fff !important;border-bottom:1px solid #ccc">
               <a href="#" onclick="history.back()"  style="text-decoration:none;flex:1;height: 50px;">
                ...
                <div  style="flex:1;color:#333;display:flex;justify-content:center;align-items:center;font-size:20px;white-space:nowrap">Lịch sử hoa hồng</div>
                <div style="flex:1;display:flex; justify-content:flex-end">
                  
                </div>
        </div>
        
        <div style="margin-top:20px;padding:15px;display:flex; justify-content:space-between;align-items:center;border-bottom:1px solid #ccc">
            <div style="display:flex;flex-direction:column">
                <span style="font-size:18px;color:#3e4cf3">Tiền thưởng khuyến khính</span>
                <span style="font-size:14px">Nhiệm vụ mới：Liên kết thẻ rút tiềnTiền thưởng chiết khấu50000.00</span>
                <span style="color:#959595">10-05-2024 19:35</span>
            </div>
            <div style="display:flex;flex-direction:column;width:200px;justify-content:center;align-items:flex-end">
                <div style="color:green;font-size:18px">50000</div>
                <span style="margin-top:10px;color:#959595">Số dư: 10000</span>
         ...
         <div style="margin-top:20px;padding:15px;display:flex; justify-content:space-between;align-items:center;border-bottom:1px solid #ccc">
            <div style="display:flex;flex-direction:column">
                <span style="font-size:18px;color:#3e4cf3">Tiền thưởng khuyến khính</span>
                <span style="font-size:14px">Nhiệm vụ mới：Đã đăng ký Tiền thưởng chiết khấu50000.00</span>
                <span style="color:#959595">10-05-2024 19:35</span> 
            </div>
            <div style="display:flex;flex-direction:column;width:200px;justify-content:center;align-items:flex-end">
                <div style="color:green;font-size:18px">50000</div>
                <span style="margin-top:10px;color:#959595">Số dư: 50000</span>
