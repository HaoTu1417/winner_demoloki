    ...
    <div class="container homecontainer " style="background:#fff">
        <div class="header-default" style="display:flex;background:rgb(62, 76, 244) !important;border-bottom:1px solid #ccc">
               <a href="#" onclick="history.back()"  style="text-decoration:none;flex:1;height: 50px;">
                ...
                <div  style="flex:1;color:#fff;display:flex;justify-content:center;align-items:center;font-size:20px;white-space:nowrap">Dự án vip</div>
        ...
        <div style="margin-top:20px;padding:15px;">
            ...
            <div class="item-price active" data-price="700000000" style="color:#333;margin-right:8px;text-align:center;margin-bottom:10px;padding:4px 24px;border:1px solid #ccc;border-radius:4px;cursor:pointer">
                  700.000.000
            </div>
            <div class="item-price " data-price="2000000000" style="color:#333;margin-right:8px;text-align:center;margin-bottom:10px;padding:4px 24px;border:1px solid #ccc;border-radius:4px;cursor:pointer">
                  2.000.000.000
            </div>
            <div class="item-price " data-price="5000000000" style="color:#333;margin-right:8px;text-align:center;margin-bottom:10px;padding:4px 24px;border:1px solid #ccc;border-radius:4px;cursor:pointer">
                  5.000.000.000
            </div>
           
            
            <div class="item-price js-item-price-other" data-price="0" style="color:#333;margin-right:8px;text-align:center;margin-bottom:10px;padding:4px 24px;border:1px solid #ccc;border-radius:4px;cursor:pointer">
                  Khác
            </div>
            ...
            <div style="color:#333;">
                <div class="list-item-price mt-3 " style="display:flex;flex-wrap: wrap;justify-content:space-between">
                    <?php if($percent != null) { ?>
                        <div class="item-price item-quantity active" data-quantity="12"  style="color:#333;margin-right:8px;text-align:center;margin-bottom:10px;padding:4px 18px;border:1px solid #ccc;border-radius:4px;cursor:pointer">
                          20 lần<br>lãi tháng<br><?= $percent->p20 ?>%
                        </div>
                        <div class="item-price item-quantity" data-quantity="12"  style="color:#333;margin-right:8px;text-align:center;margin-bottom:10px;padding:4px 18px;border:1px solid #ccc;border-radius:4px;cursor:pointer">
                          15 lần<br>lãi tháng<br><?= $percent->p15 ?>%
                        </div>
                        <div class="item-price item-quantity" data-quantity="12"  style="color:#333;margin-right:8px;text-align:center;margin-bottom:10px;padding:4px 18px;border:1px solid #ccc;border-radius:4px;cursor:pointer">
                          12 lần<br>lãi tháng<br><?= $percent->p12 ?>%
                        </div>
                        <div class="item-price item-percent" data-percent="10" style="color:#333;margin-right:8px;text-align:center;margin-bottom:10px;padding:4px 24px;border:1px solid #ccc;border-radius:4px;cursor:pointer">
              ...
              <div class="mt-4">
                   <button type="button" style="width:100%;background:rgb(62, 76, 244)" class="btn btn-primary btnCreateWallet">Tạo ví</button>
               </div>
         </div>
